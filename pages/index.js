  ...
  return (
    <section id="homepage">
      ...
      <div className="herobox">
        <Image className="hero-img" src={herobox}></Image>
        <div className="text">
          <p>Black Swan</p>
          <h1>EXQUISITE </h1>
      ...
      <div id="follow-us">
        ...
        <div className="insta-container">
          <Image src={i1} width="224px" height="200px"></Image>
          <Image src={i5} width="224px" height="200px"></Image>
          <Image src={i3} width="224px" height="200px"></Image>
          <Image src={i4} width="224px" height="200px"></Image>
          <Image src={i6} width="224px" height="200px"></Image>
          <Image src={i2} width="224px" height="200px"></Image>
        </div>
      </div>
    </section>
  );
